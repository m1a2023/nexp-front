    ...
    <div className="flex flex-row w-full h-full box-border bg-gray-200">
      ...
      >
        ...
        <div className="flex flex-col w-[100%] gap-6">
          <div className="flex w-[100%] h-full p-4 font-bold text-neutral-800 bg-gray-100 text-lg rounded-3xl shadow-2xl select-none">
            Demo block
          </div>
          <div
            onClick={homePageChangeChart}
            className="flex flex-col w-[100%] h-full pl-4 pr-3 pb-2 pt-3 grow-0 font-bold text-neutral-800  bg-gray-100 text-lg rounded-3xl shadow-2xl select-none"
          >
            <span>Expenses</span>
            ...
            {isPieChart ? (
              ...
              <div className="h-full w-full p-5 flex justify-center items-end">
                <div className={styles.pieChartPreviewBlock + " overflow-auto"}>
                  <svg
                    width="100%"
                    height="100%"
